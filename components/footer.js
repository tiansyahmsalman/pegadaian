...
export default function Footer() {
  ...
  return (
    <Flex pos="sticky" bg="gray.50" bottom="0" borderTop="1px" paddingTop='1'marginTop='auto'>
      <Center as="button" flex="1" onClick={(e)=>{handleClick(e, 'home')}}>
        <Grid align={'center'}>
          <Center>
            <svg 
      ...
      <Center as="button" flex="1" onClick={(e)=>{handleClick(e, 'profile')}}>
        <Grid>
          <Center>
            <svg 
              xmlns="http://www.w3.org/2000/svg" 
